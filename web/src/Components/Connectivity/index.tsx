...
interface InternetDetectorProps {
    onInternetStatusChange: (isOnline: boolean) => void; // Function to pass online status back to parent
}

export const ConnectivityDetector: React.FC<ConnectivityDetectorProps> = ({ onStatusChange }) => {
    ...
    return (
        <div style={{ textAlign: 'center', padding: '20px' }}>
            <h2>Server Connectivity Status</h2>
